...
public class SteppedGeneratorTest {
    ...
    public void testStepGeneratorValue() throws GeneratorLimitReachedException, GeneratorException {
        ...
        Assertions.assertEquals("000000000000000002=000000000000000002",value1);
    }
    ...
    @Test
    public void testStepGeneratorValueForLimitExceededOnGeneratorAndStepGenerator() throws GeneratorLimitReachedException, GeneratorException {

        Assertions.assertThrowsExactly(GeneratorLimitReachedException.class,()->{
            
        })
        ResettableGenerator<String,String> generator=new SteppedGenerator(Long.MAX_VALUE-1,Long.MAX_VALUE-1,1,'=');
        generator.getNext();
        String value1= generator.getNext();
        Assertions.assertEquals("000000000000000003=000000000000000002",value1);
    }
